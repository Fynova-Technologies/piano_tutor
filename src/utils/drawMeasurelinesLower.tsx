...
function drawMeasureLinesLower(yStart: number, timeSignature:{top:number,bottom:number},STAFF_WIDTH:number,CLEF_WIDTH:number): JSX.Element[] {
...
export default drawMeasureLinesLower;