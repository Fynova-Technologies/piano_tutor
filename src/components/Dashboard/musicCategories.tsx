...
const techniqueOffset = circumference - (techniqueProgress / 100) * circumference;
    ...
    <div className="relative flex items-center overflow-hidden w-full z-10 rounded-3xl">
      {/* ✅ Only change: ml-16 → ml-4 md:ml-16, w-[200px] → w-[140px] md:w-[200px] */}
      ...
      {/* ✅ Only change: left-[100px] → left-[80px] md:left-[100px], hide on xs */}
    ...
    {/* ✅ Only change: hide the side images on mobile */}
    <div className="hidden sm:flex flex-col items-center ml-auto space-y-4 p-6 group-hover:-translate-x-6 transition-transform duration-1000 ease-in-out">
      ...
      <span className="text-[#151517]">Recent Music</span>
        ...
        >
           <div className="relative flex">
    <div className="relative flex items-center overflow-hidden w-full z-10 rounded-3xl">
      {/* ✅ ml-16 → ml-4 md:ml-16, w-[200px] → w-[140px] md:w-[200px] */}
      <div className="bg-[#FEFEFE] group-hover:bg-[#f2e6c1] transition duration-300 flex flex-col items-start justify-center z-10 h-full w-[140px] md:w-[200px] ml-4 md:ml-16">
      ...
      {/* ✅ left-[230px] → left-[160px] md:left-[230px], hide on mobile */}
    ...
    {/* Score box — unchanged, always visible */}
    <div className="flex flex-col items-center p-6 rounded-2xl shadow-[0_5px_10px_0px_#505050] bg-[#FEFEFE]">
      <div className="flex flex-col items-center gap-2 w-full">
        <div className="flex gap-4">
          <Image src="/Frame.svg" alt="Frame" width={10} height={10} className="w-10 h-9 rounded-2xl object-cover" />
  ...
  <div onClick={() => router.push("/sasr")} className="bg-[#FEFEFE] rounded-2xl w-full hover:bg-[#f2e6c1] hover:rounded-3xl p-6 hover:inset-10 hover:shadow-[0_5px_10px_0px_#505050] transition duration-300 cursor-pointer group hover:scale-[1.03]">
    <div className="relative flex">
      <div className="relative flex items-center justify-between space-x-4 overflow-hidden w-full z-10 rounded-3xl">
        {/* ✅ Only change: hide bro.svg on mobile */}
        ...
        {/* ✅ Only change: always use the desktop text style, drop isMobile branch */}
        <div className="bg-[#FEFEFE] group-hover:bg-[#f2e6c1] transition duration-300 flex flex-col items-start justify-center z-10 h-full ml-4 md:ml-16 w-[200px]">
          <h3 className="text-4xl font-bold primary-color-text p-0 m-0">Method</h3>
          <h3 className="text-4xl font-bold bg-gradient-to-r from-[#5f4f19] to-[#aa8c2c] bg-clip-text text-transparent mb-2 p-0 m-0">Lessons</h3>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center ml-auto space-y-4 p-6">
        ...
        {/* ✅ Technique Lessons Card - uses techniqueProgress */}
        <div
          ...
          <div className="relative flex">
            <div className="relative flex items-center justify-between space-x-4 overflow-hidden w-full z-10 rounded-3xl">
              <div className="bg-[#FEFEFE] group-hover:bg-[#f2e6c1] transition duration-300 flex flex-col items-start justify-center z-10 h-full ml-16">
                <h3 className="text-[36px] font-bold primary-color-text p-0 m-0">Technique</h3>
                <h3 className="text-xl font-bold bg-gradient-to-r from-[#5f4f19] to-[#aa8c2c] bg-clip-text text-[36px] text-transparent mb-2 p-0 m-0">Lessons</h3>
              </div>
            </div>
            <div className="flex flex-col items-center ml-auto space-y-4 p-6">
              <div className="flex items-center gap-2 rounded-full">
                <div className="flex items-center justify-center">
                  <svg height={radius * 3} width={radius * 3} className="transform -rotate-90">
                    ...
                    <circle
                      ...
                      strokeDashoffset={techniqueOffset} // ✅ technique specific
                      strokeLinecap="round"
