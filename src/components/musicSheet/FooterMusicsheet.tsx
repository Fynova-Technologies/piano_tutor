...
export default function FooterMusicsheet({
  ...
  return (
    <div
      className={` flex fixed bottom-0 items-end justify-end bg-[#0a0a0a] w-full gap-2 p-4 ${isPlaying ? "hidden" : " "}`}
    >
      <div className="flex items-center justify-between w-full">
        ...
        <div className="Settings flex gap-4 mr-8 w-full items-end justify-end">
          <button className="bg-[#D4AF37] py-[6px] w-[101px] h-[48px] px-[16px] rounded-2xl flex gap-2 primary-color-text items-center text-[16px]">
