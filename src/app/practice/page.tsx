...
export default function PracticePage() {
  ...
  return (
    <div className="p-6 min-h-screen bg-gray-100">
      ...
      <div className="mb-3">
        <strong>Status:</strong> {ready ? `Loaded — ${events.length} events` : "Loading MusicXML... (this may take 10-30 seconds)"}
        ...
        {!ready && (
          <div className="mt-2 flex items-center gap-2 text-blue-600">
            ...
            <span className="text-sm">Rendering sheet music with OSMD...</span>
          </div>
        )}
      </div>
